module.exports = function(app) {
  app.controller('BeveragesController', ['$scope', '$http', function($scope, $http) {
    ...
    $scope.edit = function(beverage) {
      beverage.tempValue = beverage.beverageBody;
      beverage.editing = true;
    };

    $scope.cancel = function(beverage) {
      beverage.editing = true;
      beverage.beverageBody = beverage.tempValue;
    }
